...
type TUserdefinedInterruptHook=function(interruptnr: integer; newCS: word; newEIP: qword; addressofjumpback: qword):boolean; stdcall;
type TExecuteKernelCode=function(address: qword; parameters: qword): BOOL; stdcall;
